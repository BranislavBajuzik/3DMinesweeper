...
item replace entity @p hotbar.7 with written_book{title:"[Use] -> Quit Tutorial",pages:["{\"color\":\"dark_blue\",\"text\":\"\\n\\n\\n\\n\\n     Quit the Tutorial\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/trigger trigger set 6\"},\"hoverEvent\":{\"action\":\"show_text\",\"value\":\"Click!\"}}"],author:TheAl_T}
