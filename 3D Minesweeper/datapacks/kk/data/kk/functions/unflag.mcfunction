execute at @e[type=armor_stand,name=Unflag] run setblock ~ ~30 ~ white_stained_glass
tag @p remove unflag
execute as @e[type=armor_stand,name=Unflag] at @s if block ~ ~ ~ brown_stained_glass run tag @p add unflag
